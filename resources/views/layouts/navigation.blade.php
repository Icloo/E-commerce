<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" style="background-color: #1C2826; color: white">
        ...
        <div class="flex justify-between h-26">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <img src="{{url('/img/logo.png')}}" style="height: 10vh">
                    </a>
                </div>
                ...
                <x-nav-link>
                    ...
                    <x-nav-link :href="route('carts.index')" :active="request()->routeIs('carts.index')" style="color : white">
